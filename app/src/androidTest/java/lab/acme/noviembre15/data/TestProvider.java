...
public class TestProvider extends AndroidTestCase {
     ...
     */
     public void deleteAllRecordsFromProvider() {
        String mMsg = "ILG deleteAllRecordsFromProvider: " + Provider.CONTENT_URI.toString();
        ...
        assertEquals("Error: Records not deleted from FACTS table during delete", 0, cursor.getCount());
        cursor.close();
   ...
   @Override
    ...
    /*
        ...
        Students: Uncomment this test to make sure you've correctly registered the Provider.
     */
    public void testProviderRegistry() {
        String mMsg = "ILG testProviderRegistry(): " + mContext.getPackageName();
        Log.d(LOG_TAG, mMsg);
        ...
        try {
            ...
            assertEquals("Error: WeatherProvider registered with authority: " + providerInfo.authority +
                            " instead of authority: " + FactsContract.CONTENT_AUTHORITY,
                    providerInfo.authority, FactsContract.CONTENT_AUTHORITY);
   ...
   /*    public void testGetType() {
        ...
        // lab.acme.noviembre15/facts/
        String type = mContext.getContentResolver().getType(Provider.CONTENT_URI);
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        // vnd.android.cursor.dir/lab.acme.noviembre15/facts
        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
                Provider.CONTENT_TYPE, type);

        String mMsg = "ILG testGetType(): " + type;
        Log.d(LOG_TAG, mMsg);
        ...
        assertEquals("Error: the WeatherEntry CONTENT_URI with location should return WeatherEntry.CONTENT_TYPE",
                Provider.CONTENT_ITEM_TYPE, type);
